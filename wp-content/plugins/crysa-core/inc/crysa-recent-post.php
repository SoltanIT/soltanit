<?php
/**
* Crysa Recent Post widget
*
* Displays Recent Post widget
*
* @author 		validthemes
* @category 	Widgets
* @package 		crysa-core/widgets
* @version 		1.0.0
* @extends 		WP_Widget
*/
class crysa_Recent_Post_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description'                 => esc_html__('The most recent posts on your site', 'crysa-core'),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'crysa-recent-posts', esc_html__('Crysa Recent Posts', 'crysa-core'), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		<ul>
			<?php foreach ( $r->posts as $recent_post ) : ?>
				...
				$title 	= ( ! empty( $post_title ) ) ? $post_title : esc_html__( 'no title', 'crysa-core' );
				...
				<li>
                    ...
                    <div class="thumb">
                        <a href="<?php the_permalink( $recent_post->ID ); ?>">
                            <img src="<?php echo esc_url( $image[0] ) ?>" alt="<?php echo esc_attr__( 'crysa', 'crysa-core' ); ?>">
                        </a>
                    </div>
                    <?php endif; ?>
                    <div class="info">
	...
	public function form( $instance ) {
		...
		?>
		<p><label for="<?php echo wp_specialchars_decode( $this->get_field_id( 'title' ) ); ?>"><?php echo esc_html__( 'Title:', 'crysa-core' ); ?></label>
        ...
        <p><label for="<?php echo wp_specialchars_decode( $this->get_field_id( 'number' ) ); ?>"><?php echo esc_html__( 'Number of posts to show:', 'crysa-core' ); ?></label>
...
function crysa_register_custom_widgets() {
    register_widget( 'crysa_Recent_Post_Widget' );
}
add_action( 'widgets_init', 'crysa_register_custom_widgets' );	